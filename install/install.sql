...
VALUES
  ...
  (4,0,'usergroup',0,'comment_on_tickets',1),
  (5,0,'usergroup',0,'update_tickets',1),
  (6,0,'usergroup',0,'edit_ticket_description',0),
  (7,0,'usergroup',0,'vote_on_tickets',1),
  (8,0,'usergroup',0,'add_attachments',1),
  (9,0,'usergroup',0,'view_attachments',1),
  (10,0,'usergroup',0,'delete_attachments',0),
  (11,0,'usergroup',0,'set_all_ticket_properties',0),
  (12,0,'usergroup',0,'edit_ticket_history',0),
  (13,0,'usergroup',0,'delete_ticket_history',0),
  (14,0,'usergroup',0,'create_wiki_page',0),
  (15,0,'usergroup',0,'edit_wiki_page',0),
  (16,0,'usergroup',0,'delete_wiki_page',0),
  (17,0,'usergroup',0,'create_tickets',0),
  (18,0,'usergroup',3,'comment_on_tickets',0),
  (19,0,'usergroup',3,'update_tickets',0),
  (20,0,'usergroup',3,'vote_on_tickets',0),
  (21,0,'usergroup',3,'add_attachments',0),
  (22,0,'role',0,'view',1),
  (23,0,'role',0,'project_settings',0),
  (24,0,'role',0,'create_tickets',1),
  (25,0,'role',0,'comment_on_tickets',1),
  (26,0,'role',0,'update_tickets',1),
  (27,0,'role',0,'edit_ticket_description',0),
  (28,0,'role',0,'vote_on_tickets',1),
  (29,0,'role',0,'add_attachments',1),
  (30,0,'role',0,'view_attachments',1),
  (31,0,'role',0,'delete_attachments',0),
  (32,0,'role',0,'set_all_ticket_properties',1),
  (33,0,'role',0,'edit_ticket_history',0),
  (34,0,'role',0,'delete_ticket_history',0),
  (35,0,'role',0,'create_wiki_page',0),
  (36,0,'role',0,'edit_wiki_page',0),
  (37,0,'role',0,'delete_wiki_page',0),
  (38,0,'role',1,'project_settings',1),
  (39,0,'role',1,'edit_ticket_description',1),
  (40,0,'role',1,'delete_attachments',1),
  (41,0,'role',1,'edit_ticket_history',1),
  (42,0,'role',1,'delete_ticket_history',1),
  (43,0,'role',1,'create_wiki_page',1),
  (44,0,'role',1,'edit_wiki_page',1),
  (45,0,'role',1,'delete_wiki_page',1);

<nav id="project_settings_nav" class="tabs">
	<ul>
		...
		<li<?php echo iif(active_nav('/:slug/settings/members(.*)'), ' class="active"')?>><?php echo HTML::link(l('members'), "{$project->slug}/settings/members"); ?></li>
		...
		<?php FishHook::run('template:projectsettings/_nav', array($project)); ?>
	</ul>
</nav>
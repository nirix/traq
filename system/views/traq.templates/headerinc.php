...
<link rel="stylesheet" href="<?php echo baseurl(); ?>js/likeaboss/css/editor.css" type="text/css" />
...
<script src="<?php echo baseurl(); ?>js/likeaboss/likeaboss.js" type="text/javascript"></script>
